/**
 * Clerk Frontend API proxy for Replit-managed production domains.
 * This middleware is intentionally inactive during development.
 */
...
export function clerkProxyMiddleware(): RequestHandler {
  ...
  return createProxyMiddleware({
    ...
    pathRewrite: (proxyPath: string) =>
      proxyPath.replace(new RegExp(`^${CLERK_PROXY_PATH}`), ""),
    on: {
